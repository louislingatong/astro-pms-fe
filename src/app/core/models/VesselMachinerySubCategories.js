...
export default function VesselMachinerySubCategories(data = {}) {
  ...
  this.sub_category = data.sub_category ? new MachinerySubCategory(data.sub_category) : new MachinerySubCategory();
  this.description = data.description ? new MachinerySubCategoryDescription(data.description) : new MachinerySubCategoryDescription();
}
